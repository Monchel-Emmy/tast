...
$result = mysqli_query( $con,"SELECT * FROM lecturer WHERE l_id = $id ");
while( $row = mysqli_fetch_assoc($result)){  
    ?>
                    <form action="update_lecturer_process.php" method="post">
                        <input type="hidden" name="id" value="<?php echo $row['l_id']; ?>">
                    <div class="grid2">
                        Firstname:<br>
                        <input type="text" name="fname" value="<?php echo $row['l_firstname']; ?>" id=""><br>
                        Lastname:<br>
                        <input type="text" name="lname" value="<?php echo $row['l_lastname']; ?>"  id=""><br>
                        Email:<br>
                        <input type="text" name="email"  value="<?php echo $row['l_email']; ?>" id=""><br>
                        Password:<br>
                        <input type="text" name="pname"  value="<?php echo $row['l_password']; }?>"id=""><br>
                     <br> <p>
