...
<?php
  ...
  <h2>Bellow are same exercises you can work to develop your skills  ! </h2><br><P>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
   ...
   <div class="book" style="height: 15rem; background-color: blanchedalmond;"> <center><span><h2>BOOK name</h2>
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, omnis?</p>
    <img src="logo.png" alt=""><br><button>Download</button> </span></center><br>
   
   
  
   </div>

   <div class="book" style="height: 17rem; background-color: blanchedalmond;"> <center><span><h2>BOOK name</h2>
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, omnis?</p>
    <img src="logo.png" alt=""><br><button>Download</button> </span></center><br>
